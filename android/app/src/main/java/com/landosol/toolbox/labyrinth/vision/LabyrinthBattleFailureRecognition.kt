...
class LabyrinthBattleFailureDetector(
    ...
    fun detect(frame: PixelImage): LabyrinthBattleFailureObservation? {
        ...
        val reportSample = map(frame, DAMAGE_REPORT_SAMPLE) ?: return null
    ...
    private companion object {
        ...
        val DAMAGE_REPORT_SAMPLE = EntryReferenceRect(1600, 55, 220, 45)
